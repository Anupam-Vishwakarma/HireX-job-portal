...
export default function BusinessCTA() {
  return (
    <section className="relative w-full bg-[#020617] overflow-hidden border-y border-white/[0.06]">
      ...
      {/* Glow blobs */}
      <div className="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-blue-600/10 blur-[100px] pointer-events-none z-0" />
      <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-blue-500/8 blur-[100px] pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-7xl 2xl:max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-16 py-16 sm:py-20 lg:py-24">
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="relative group">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-white/[0.08] aspect-[4/3]">
                <Image
                  ...
                  alt="Business agentic automation"
                  fill
                  sizes="(max-width: 1024px) 100vw, 50vw"
                  className="object-cover transition-transform duration-700 group-hover:scale-105"
                />
                <div className="absolute inset-0 bg-gradient-to-tl from-[#020617]/60 via-transparent to-blue-900/20" />
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="absolute bottom-5 right-5 flex items-center gap-3 rounded-xl px-4 py-3 z-10"
                  style={{
                ...
                >
                  ...
                  <div>
                    <p className="text-white text-xs font-semibold">Agent deployed</p>
                    <p className="text-gray-500 text-[10px]">Agentic workflow · Live</p>
                  </div>
                </motion.div>
              </div>
            </div>
          ...
          >
            ...
            ">
              Are you a{" "}
              <span className="italic font-light text-blue-400">business</span>{" "}
              needing{" "}
            ...
            <p className="text-gray-500 font-light leading-relaxed text-[clamp(14px,1.8vw,17px)] mb-10 max-w-lg mx-auto lg:mx-0">
              Connect with pre-vetted AI agents and specialists ready to automate your workflows, cut operational costs, and scale your business intelligence instantly.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <motion.button
                ...
                "
              >
                <span className="relative z-10">Hire an Agent</span>
                <motion.div
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="
                  text-gray-400 hover:text-white font-medium text-sm
